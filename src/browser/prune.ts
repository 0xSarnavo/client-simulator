 ...
 * — and site-a.dev's signup form is one, so a pattern that only matches `eN`
 ...
 * a small distortion: on site-a.dev it is 776 refs against 37 a visitor could
...
export function splitByViewport(
   ...
   * whichever section happens to sit just under the fold — on site-a.dev that
