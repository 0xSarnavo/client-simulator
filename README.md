...
Clients can complete real signups. Each run mints an ephemeral mailbox (`cold.a1b2@yourdomain.com`), receives the OTP or magic link, and the client types it in. Everything is purged when the run ends.
